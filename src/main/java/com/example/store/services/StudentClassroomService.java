...
public class StudentClassroomService {
    ...
    public String deleteAllByStudentId(int studentId) {
        studentClassroomRepository.deleteAllByStudentId(studentId);
        return "All classrooms removed from student successfully";
    }
}
